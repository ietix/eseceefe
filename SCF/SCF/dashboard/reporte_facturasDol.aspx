<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="reporte_facturasDol.aspx.cs" Inherits="SCF.dashboard.reporte_facturasDol" %>
                            ...
                            <form action="#" class="horizontal-form">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <asp:Button type="button" class="btn blue" runat="server" ID="btnGenerarReporte" Text="Generar Reporte" OnClick="btnGenerarReporte_Click" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
